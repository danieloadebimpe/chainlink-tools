...
contract ConsumePi is ChainlinkClient {
    ...
    address constant rink_link = 0x01BE23585060835E02B77ef475b0Cc51aA1e0709;
    
    constructor() {
        // set the variables upon deployment

        // set to the Rinkeby Token Address
        setChainlinkToken(rink_link);
        // set the contract owner to person deploying contract
        owner = msg.sender;
        // TestOracle Address
        oracle = 0xee04451ac26bB7fe0fA1596DB06Df7fBFef5BD91;
        // direct request 
        //jobId = "1107006c124a4ecc891676ef7bae7e45";
    ...
    function requestData() public returns (bytes32 requestId) 
    {
        ...
        // request.add("get", url);
        request.add("path", "cpuTemp");

        int timesAmount = 10**18;
        
        request.add("pi_temp", "cpuTemp");
